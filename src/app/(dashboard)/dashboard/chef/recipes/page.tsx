  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">Lihat daftar resep dan detailnya.</p>
      </div>
      ...
      <div className="rounded-[28px] border border-border bg-surface p-7 shadow-sm">
        ...
        <p className="mt-2 text-sm leading-6 text-muted">List resep akan ditampilkan di sini.</p>
      </div>
    </section>
  );
}
